<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="insideTraining.aspx.cs" Inherits="seniorProject.insideTraining" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <section  class="breadcrumbs" >
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2><asp:Localize ID="locTrainingInside1" meta:resourceKey="locRTrainingInside1" Text="Inside Training" runat="server"></asp:Localize></h2>
          <ol>
            ...
            <li><asp:Localize ID="locTrainingInside2" meta:resourceKey="locRTrainingInside2" Text="Inside Training" runat="server"></asp:Localize></li>
    ...
    <div class="container min-container py-md-5 mt-4">
        <div class="card-panel p-sm-5 position-relative">
            <div class="text-center">
                <!-- Icon -->
                <img src="assets/img/03-Location-icon.png" style="height: 150px; width: 150px;" alt="Icon" />
                <h1 class="h2 mt-5"><asp:Localize ID="locTrainingInside3" meta:resourceKey="locRTrainingInside3" Text="Inside Training" runat="server"></asp:Localize></h1>
            </div>
            <hr />
                    ...
                    <Columns>
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtEditCollege" runat="server" Text='<%# Bind("collegeId") %>'></asp:TextBox>
                                ...
                                &nbsp;<asp:Label ID="lblEditCollege" runat="server" />
                        </EditItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="110px" meta:resourcekey="TemplateFieldResource7">
                            <ItemTemplate>
