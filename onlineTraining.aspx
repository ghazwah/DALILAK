<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="onlineTraining.aspx.cs" Inherits="seniorProject.onlineTraining" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <section  class="breadcrumbs" >
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2><asp:Localize ID="locTrainingOnline1" meta:resourceKey="locRTrainingOnline1" Text="Online Training" runat="server"></asp:Localize></h2>
          <ol>
            ...
            <li><asp:Localize ID="locTrainingOnline2" meta:resourceKey="locRTrainingOnline2" Text="Online Training" runat="server"></asp:Localize></li>
    ...
    <div class="container min-container py-md-5 mt-4">
        <div class="card-panel p-sm-5 position-relative">
            <div class="text-center">
                <!-- Icon -->
                <img src="assets/img/training-online.png" style="height: 200px; width: 300px;" alt="Icon" />
                <h1 class="h2 mt-5"><asp:Localize ID="locTrainingOnline3" meta:resourceKey="locRTrainingOnline3" Text="Online Training" runat="server"></asp:Localize></h1>
            </div>
            <hr />
