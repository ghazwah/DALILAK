...
{
    public partial class insideTraining : System.Web.UI.Page
    {
        ...
        protected void populateGvDocs()
        {
            ...
            string mySql = @"select trainingprogramId,collegeId,name, documentName, dateUploaded
                                     from trainingprogram trpr inner join  admin ad on trpr.adminId=ad.adminId  where trpr.trainingprogramtypeId = 1";
